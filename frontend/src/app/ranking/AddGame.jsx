...
export default function AddGame({ data }) {
  ...
  const handleSubmit = async (e) => {
    ...
    const formattedData = {
      team1_score: parseInt(team1Score, 10) || 0,
      team2_score: parseInt(team2Score, 10) || 0,
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <Select id="team-name-1" onValueChange={(value) => {
            ...
            <div className="space-y-2">
              ...
              <Input id="team-points-1" placeholder="Enter team points" type="number" value={team1Score} onChange={(e) => setTeam1Score(e.target.value)} />
            </div>
            <div className="space-y-2">
              <Label htmlFor="team-name-2">Team Name</Label>
              <Select id="team-name-2" onValueChange={(value) => {
                const selectedTeam = data.find(team => team.name === value);
            ...
            <div className="space-y-2">
              ...
              <Input id="team-points-2" placeholder="Enter team points" type="number" value={team2Score} onChange={(e) => setTeam2Score(e.target.value)} />
            </div>
          </div>
